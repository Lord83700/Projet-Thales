...
if __name__ == '__main__': 
    ...
    argParser.add_argument("-n", "--nom", type=str, help="Nom du test pour ce fichier binaire") # Argument -n pour le nom du test
    argParser.add_argument("-d", "--date", type=str, help="Date du test pour ce fichier binaire") # Argument -d pour la date du test
    ...
    if args.rep:
        ...
        try:
            ...
            sys.exit("Veuillez fournir un nom de fichier rep existant ou vérifiez la validité du nom donné")
        ...
        mySql_insert_query = """INSERT INTO fic (nomfic,dt)
                                    VALUES (%s, %s) """ # Création de la requête pour envoyer les informations du fichier rep dans la base
                                    
        record = (nt, dt,) # Création d'une variable contenant les informations à envoyer
        ...
        sys.exit("Veuillez fournir le nom d'un fichier rep (-r), ou bien le nom et la date du test (-n et -d)")
    try:
        ...
        sys.exit("Veuillez fournir un nom de fichier brut existant ou vérifiez la validité du nom donné")
    except TypeError:
        sys.exit("Aucun fichier brut saisi")
